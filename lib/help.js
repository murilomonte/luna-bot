...
export let start = async(luna, name) => {
...
export let help = async(luna, name, user_id) => {
...
export let downloader = async(luna, user_id) => {
...
export let anime = async(luna, user_id) => {
    prefix = config.prefix
    text = `Anime Menu :
...
export let randimage = async(luna, user_id) => {
    prefix = config.prefix
...
export let messageError = async(luna) => {
